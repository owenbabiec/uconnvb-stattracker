...
# Set, rotation, serve information
col1, col2, col3, col4 = st.columns(4)

with col1:
    st.session_state.set = st.radio("Select Set", [1, 2, 3, 4, 5])
with col2:
    st.radio("UConn Starting Rotation", [1, 2, 3, 4, 5])
with col3:
    st.radio(f"{st.session_state.opp} Starting Rotation", [1, 2, 3, 4, 5])
with col4:
    st.radio("Starting Serve", ["UConn", st.session_state.opp])
